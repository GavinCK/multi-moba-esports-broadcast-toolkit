...
export const LOL_SAMPLE_STANDARD_RULESET: DraftRuleset = {
  ...
  phases: [
    ...
    { id: "pick-red-1-2", type: "PICK", team: "RED", count: 2, timeSeconds: 60, label: "Red Picks 1-2", allowHover: true, autoAdvance: true },
    { id: "pick-blue-2-3", type: "PICK", team: "BLUE", count: 2, timeSeconds: 60, label: "Blue Picks 2-3", allowHover: true, autoAdvance: true },
    ...
    { id: "pick-blue-4-5", type: "PICK", team: "BLUE", count: 2, timeSeconds: 60, label: "Blue Picks 4-5", allowHover: true, autoAdvance: true },
